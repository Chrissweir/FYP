			...
			<form action="Register" role="form">
				...
				<div class="form-group">
					<label class="control-label" for="signupEmailagain">Email
						...
						class="form-control" onblur="confirmEmail()"> <label
						id="emailLabel" style="color: red; display: none">Emails
						must Match!</label>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="control-label" for="signupPasswordagain">Confirm
						Password</label> <input id="signupPasswordagain" type="password"
						maxlength="25" class="form-control" onblur="confirmPassword()">
					<label id="passwordLabel" style="color: red; display: none">Passwords
						must Match!</label>
				</div>
				<div class="form-group">
					<label class="control-label" for="signupCollege">College</label> <input
						id="signupCollege" name="college" type="text" maxlength="25"
						class="form-control" onblur="confirmCollege()">
						<label id="collegeLabel" style="color: red; display: none">College Required!</label>
				</div>
				<div class="form-group">
